  ...
  return (
    <footer className="bg-gray-800 text-white py-6">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* About Section */}
        <div>
          <h2 className="font-bold text-lg mb-4">About SwiftCard</h2>
          <p className="text-sm text-gray-400">
            SwiftCard is a modern e-commerce platform offering top-quality
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>Email: support@swiftcard.com</li>
            <li>Phone: +123 456 7890</li>
            <li>Address: 123 SwiftCard St, E-commerce City</li>
          </ul>
